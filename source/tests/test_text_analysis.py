...
class TestTextAnalysis(unittest.TestCase):
    ...
    def test__count_tokens(self):
        ...
        dataframe_to_text_file(count_tokens([tokens, tokens], min_frequency=1),
                               get_test_file_path('text_analysis/count_tokens__list_of_lists__min_freq_1.txt'))  # noqa
        dataframe_to_text_file(count_tokens([tokens, tokens], min_frequency=2),
                               get_test_file_path('text_analysis/count_tokens__list_of_lists__min_freq_2.txt'))  # noqa
        ...
        dataframe_to_text_file(count_tokens(pd.Series(tokens), min_frequency=1),
                               get_test_file_path('text_analysis/count_tokens__series_strings__min_freq_1.txt'))  # noqa
        dataframe_to_text_file(count_tokens(pd.Series(tokens), min_frequency=2),
                               get_test_file_path('text_analysis/count_tokens__series_strings__min_freq_2.txt'))  # noqa
        ...
        self.assertEqual(counts,
                         {'sentence': 4, 'numbers': 4, 'punctuation': 2, 'also': 2, 'nevermind': 2, 'dumb': 2})  # noqa
    ...
    def test__term_frequency(self):
        ...
        term_freq = term_frequency(df=self.un_debates, tokens_column='tokens',
        ...
        dataframe_to_text_file(term_freq,
                               get_test_file_path('text_analysis/term_frequency__un_debates__by_year__min_freq_3.txt'))  # noqa
        ...
        dataframe_to_text_file(term_freq,
                               get_test_file_path('text_analysis/term_frequency__un_debates__by_year_country__min_freq_3.txt'))  # noqa
    ...
    def test__inverse_document_frequency(self):
        ...
        dataframe_to_text_file(idf,
                               get_test_file_path('text_analysis/inverse_document_frequency__un_debates__min_freq_2.txt'))  # noqa
    ...
    def test__count_keywords_by(self):
        ...
        dataframe_to_text_file(keyword_counts_per_year,
                               get_test_file_path('text_analysis/count_keywords_by__un_debates__year__count_once.txt'))  # noqa
