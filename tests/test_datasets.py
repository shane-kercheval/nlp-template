...
def test__datasets():
    ...
    assert data.other_dataset_2._data is None
    ...
    assert data.other_dataset_2._data is not None
    ...
    assert data.dataset_3_csv._data is None
    ...
    assert data.dataset_3_csv._data is not None
