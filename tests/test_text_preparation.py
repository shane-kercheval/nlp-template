...
#     assert stop_words_to_add.isdisjoint(STOP_WORDS_DEFAULT)
#     assert stop_words_to_remove < STOP_WORDS_DEFAULT
#     assert [x.is_stop for x in sp._nlp("dear regard down")] == [False, False, True]

#     sp = SpacyWrapper(stopwords_to_add=stop_words_to_add, stopwords_to_remove=stop_words_to_remove)
#     assert sp.stop_words != STOP_WORDS_DEFAULT
#     assert stop_words_to_add < sp.stop_words
